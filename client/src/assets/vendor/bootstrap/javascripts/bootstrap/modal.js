...
+function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    var that = this
    var e    = $.Event('modal', { relatedTarget: _relatedTarget })
    ...
    this.$dialog.on('modal', function () {
      that.$element.one('modal', function (e) {
  ...
  Modal.prototype.enforceFocus = function () {
    $(document)
      .off('modal') // guard against infinite focus loop
  ...
  Modal.prototype.resize = function () {
    if (this.isShown) {
      $(window).on('modal', $.proxy(this.handleUpdate, this))
    } else {
      $(window).off('modal')
    }
  }
